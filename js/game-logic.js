...
if (bgMusic) {
    ...
    if (ciclo >= 15) {
        nuovaMusica = 'mp3/part4.mp3';  // Livelli 20-24
    } else if (ciclo >= 10) {
        nuovaMusica = 'mp3/part3.mp3';  // Livelli 15-19
    } else if (ciclo >= 5) {
        nuovaMusica = 'mp3/part2.mp3';  // Livelli 5-14
    } else {
        nuovaMusica = 'mp3/soundtrack.mp3'; // Livelli 1-4
    }
